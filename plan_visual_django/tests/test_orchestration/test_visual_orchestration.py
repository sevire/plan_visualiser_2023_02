...
class TestVisualOrchestration(TestCase):
    ...
    @data(*generate_test_data_field_stream_multiple_inputs(
        ...
        test_data=[
            ...
            (4, "timelines", 2, True, "Jul", (31*1000/275)/2, 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 4, True, "Aug", ((31+(31/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 6, True, "Sep", ((31+31+(30/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 8, True, "Oct", ((31+31+30+(31/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 10, True, "Nov", ((31+31+30+31+(30/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 12, True, "Dec", ((31+31+30+31+30+(31/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 14, True, "Jan", ((31+31+30+31+30+31+(31/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 16, True, "Feb", ((31+31+30+31+30+31+31+(29/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 18, True, "Mar", ((31+31+30+31+30+31+31+29+(31/2))*1000/275), 0+25/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 20, True, "Jul - Sep", (((31+31+30)/2)*1000/275), 0+25+15/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 22, True, "Oct - Dec", (((31+31+30)+(31+30+31)/2)*1000/275), 0+25+15/2, "center", "middle", "rgb(64,64,64)"),
            (4, "timelines", 24, True, "Jan - Mar", (((31+31+30+31+30+31)+(31+29+31)/2)*1000/275), 0+25+15/2, "center", "middle", "rgb(64,64,64)"),
