...
import { get_activity_data, checkKey, get_activities_from_server } from "./visual";
...
window.get_activities_from_server = get_activities_from_server;
window.checkKey = checkKey;
window.get_activity_data = get_activity_data;
window.initialise_canvas = initialise_canvas;
window.plot_visual = plot_visual;
